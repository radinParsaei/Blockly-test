    ...
    var r = e("../lib/oop"),
        ...
        u = function(e) {
            var t = this.createKeywordMapper({
                    "variable.language": "",
                    keyword: "else|func|if|return|for|var|while|break|continue|class|init|new|this",
            ...
            this.$rules = {
                ...
                property: [{
                    ...
                    regex: /(toString|substring|replace|isEmpty|append|insert|get(RandomItem|(First|Last)(Character|Item)|FromEnd|RandomCharacter)?|charAt(FromEnd)?|to(Upper|Lower|Title)(Case)?|(starts|ends)With|contains|includes|equals(IgnoreCase)?|matches|codePointAt|trim(Right|Left)?|(lastI|i)ndexOf)\b(?=\()/
                },
                // {
